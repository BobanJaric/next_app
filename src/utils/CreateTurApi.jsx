...
import { formatDateDOE, formatDateNaslov, formatDateNaslovSlash, formatDoe } from './globalFunctions';
  ...
  const DataSet = [
    {
      ...
      data: exportData.map((data) => [
        ...
        { value: formatDateNaslov(data.dob), style: { font: { sz: '12' } } },
        { value: data.gender, style: { font: { sz: '12' } } },
        { value: countries.find(c => c.code === data.nat)?.name || "", style: { font: { sz: '12' } } },
        { value: '', style: { font: { sz: '12' } } },
        { value: 'Passenger', style: { font: { sz: '12' } } },
        { value: 'Passport', style: { font: { sz: '12' } } },
        { value: data.pas, style: { font: { sz: '12' } } },
        { value: countries.find(c => c.code === data.nat)?.name || "", style: { font: { sz: '12' } } },
        { value: formatDateDOE(data.doe), style: { font: { sz: '12' } } },
